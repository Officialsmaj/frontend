...
// Contact form submit opens user's email app and sends to your email
...
if (contactForm) {
    contactForm.addEventListener('submit', (e) => {
        ...
        const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=officialsmaj@gmail.com&su=${subject}&body=${body}`;
